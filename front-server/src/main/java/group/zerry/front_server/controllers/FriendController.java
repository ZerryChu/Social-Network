...
public class FriendController {
	...
	public String showFriendsByGroupname(HttpServletRequest request, HttpServletResponse response, String username, String userToken, String groupname, int flag) throws UnsupportedEncodingException {
		if (flag == 0) {
			Cookie cookie;
	...
	public String showGroupsByUsername(HttpServletRequest request, HttpServletResponse response, String username, String userToken, int flag) throws UnsupportedEncodingException {
		if (flag == 0) {
			Cookie cookie;
